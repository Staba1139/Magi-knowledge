...
create table MAIL_HOOKS (
  HOOK_ID INT GENERATED BY DEFAULT AS IDENTITY not null
...
comment on column MAIL_POSTS.POST_KIND is '投稿区刁E 1: Knowledge 2:Comment';
...
comment on column MAIL_POSTS.INSERT_DATETIME is '登録日晁E;
comment on column MAIL_POSTS.UPDATE_USER is '更新ユーザ';
comment on column MAIL_POSTS.UPDATE_DATETIME is '更新日晁E;
...
comment on column MAIL_HOOK_CONDITIONS.CONDITION_KIND is '条件の種顁E 1:宛�Eが「条件斁E��」であった場吁E;
comment on column MAIL_HOOK_CONDITIONS.CONDITION is '条件の斁E��E;
comment on column MAIL_HOOK_CONDITIONS.PROCESS_USER is '投稿老E;
comment on column MAIL_HOOK_CONDITIONS.PROCESS_USER_KIND is '投稿老E�E持E��E 1:送信老E�Eメールアドレスから、E:常に固宁E;
comment on column MAIL_HOOK_CONDITIONS.PUBLIC_FLAG is '公開区刁E;
comment on column MAIL_HOOK_CONDITIONS.TAGS is 'タグ';
comment on column MAIL_HOOK_CONDITIONS.VIEWERS is '公開�E';
comment on column MAIL_HOOK_CONDITIONS.EDITORS is '共同編雁E��E;
comment on column MAIL_HOOK_CONDITIONS.INSERT_USER is '登録ユーザ';
comment on column MAIL_HOOK_CONDITIONS.INSERT_DATETIME is '登録日晁E;
comment on column MAIL_HOOK_CONDITIONS.UPDATE_USER is '更新ユーザ';
comment on column MAIL_HOOK_CONDITIONS.UPDATE_DATETIME is '更新日晁E;
comment on column MAIL_HOOK_CONDITIONS.DELETE_FLAG is '削除フラグ';

comment on table MAIL_HOOKS is '受信したメールからの処琁E;
...
comment on column MAIL_HOOKS.INSERT_DATETIME is '登録日晁E;
comment on column MAIL_HOOKS.UPDATE_USER is '更新ユーザ';
comment on column MAIL_HOOKS.UPDATE_DATETIME is '更新日晁E;
