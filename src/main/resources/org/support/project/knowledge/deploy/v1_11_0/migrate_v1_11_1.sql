...
comment on table LIKE_COMMENTS is 'コメント�EイイチE;
comment on column LIKE_COMMENTS.NO is 'NO';
comment on column LIKE_COMMENTS.COMMENT_NO is 'コメント番号';
comment on column LIKE_COMMENTS.LIKE_CLASS is '種顁E;
comment on column LIKE_COMMENTS.INSERT_USER is '登録ユーザ';
comment on column LIKE_COMMENTS.INSERT_DATETIME is '登録日晁E;
comment on column LIKE_COMMENTS.UPDATE_USER is '更新ユーザ';
comment on column LIKE_COMMENTS.UPDATE_DATETIME is '更新日晁E;
...
comment on column LIKES.LIKE_CLASS is '種顁E;
...
comment on column USER_NOTIFICATIONS.STATUS is 'スチE�Eタス';
comment on column USER_NOTIFICATIONS.ROW_ID is '行ID';
comment on column USER_NOTIFICATIONS.INSERT_USER is '登録ユーザ';
comment on column USER_NOTIFICATIONS.INSERT_DATETIME is '登録日晁E;
comment on column USER_NOTIFICATIONS.UPDATE_USER is '更新ユーザ';
comment on column USER_NOTIFICATIONS.UPDATE_DATETIME is '更新日晁E;
...
comment on column NOTIFICATIONS.CONTENT is 'メチE��ージ';
comment on column NOTIFICATIONS.ROW_ID is '行ID';
comment on column NOTIFICATIONS.INSERT_USER is '登録ユーザ';
comment on column NOTIFICATIONS.INSERT_DATETIME is '登録日晁E;
comment on column NOTIFICATIONS.UPDATE_USER is '更新ユーザ';
comment on column NOTIFICATIONS.UPDATE_DATETIME is '更新日晁E;
