...
comment on column READ_MARKS.INSERT_DATETIME is '登録日晁E;
comment on column READ_MARKS.UPDATE_USER is '更新ユーザ';
comment on column READ_MARKS.UPDATE_DATETIME is '更新日晁E;
...
comment on column NOTICES.MESSAGE is 'メチE��ージ';
comment on column NOTICES.START_DATETIME is '掲示開始日時！ETC�E�E;
comment on column NOTICES.END_DATETIME is '掲示終亁E��時！ETC�E�E;
comment on column NOTICES.ROW_ID is '行ID';
comment on column NOTICES.INSERT_USER is '登録ユーザ';
comment on column NOTICES.INSERT_DATETIME is '登録日晁E;
comment on column NOTICES.UPDATE_USER is '更新ユーザ';
comment on column NOTICES.UPDATE_DATETIME is '更新日晁E;
