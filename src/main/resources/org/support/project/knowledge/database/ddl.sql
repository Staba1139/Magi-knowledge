...
create table COMMENTS (
  COMMENT_NO BIGINT GENERATED BY DEFAULT AS IDENTITY not null
  , KNOWLEDGE_ID bigint not null
  , COMMENT text
...
create table VOTES (
  VOTE_NO BIGINT GENERATED BY DEFAULT AS IDENTITY not null
  , KNOWLEDGE_ID bigint not null
...
create table VIEW_HISTORIES (
  HISTORY_NO BIGINT GENERATED BY DEFAULT AS IDENTITY not null
  , KNOWLEDGE_ID bigint not null
...
create table KNOWLEDGE_FILES (
  FILE_NO BIGINT GENERATED BY DEFAULT AS IDENTITY not null
  , KNOWLEDGE_ID bigint
  , COMMENT_NO bigint
  , DRAFT_ID bigint
  , FILE_NAME character varying(256)
...
create table KNOWLEDGES (
  KNOWLEDGE_ID BIGINT GENERATED BY DEFAULT AS IDENTITY not null
  , TITLE character varying(1024) not null
  , CONTENT text
  , PUBLIC_FLAG integer
  , TAG_IDS character varying(1024)
